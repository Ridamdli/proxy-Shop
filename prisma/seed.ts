  ...
  const products = [
    {
      ...
      metaDescription:
        "Experience premium audio with our wireless Bluetooth headphones featuring noise cancellation.",
    },
    {
      name: "Cotton T-Shirt",
      slug: "cotton-t-shirt",
    ...
    },
    {
      ...
      description:
        "WiFi-enabled security camera with night vision, motion detection, and mobile app control.",
    ...
    },
    {
      ...
      slug: "yoga-mat",
      description:
        "Non-slip yoga mat made from eco-friendly materials, perfect for all types of yoga practice.",
    ...
    },
    {
      ...
      description:
        "Complete set of programming books covering JavaScript, Python, and React development.",
